...
-------------------------------------------------------
  ...
  /socks=HOST:PORT
                 ...
                 dials through a SOCKS5 proxy, e.g. /socks=127.0.0.1:9050 for local Tor
  ...
  /onionservice=HOST.onion:PORT
                 advertise this node's Tor hidden service in its signed .btf descriptor
